...
class NoteController: ObservableObject {
    ...
    @Published var previewNotes: [Note] = [
        ...
        Note(title: "Second Note", bodyText: "This is my second note, this is so cool. SwiftUI is awesome!", audioFilename: "audioFile1.mp3", color: Color("cardColor3"), category: "Misc."),
